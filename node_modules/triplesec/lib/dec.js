...
(function() {
  ...
  Decryptor = (function(_super) {
    ...
    Decryptor.prototype.read_header = function(cb) {
      ...
      if(wa == null) err = new Error("Ciphertext underrun in header");
      else{
        console.log(wa);
        //console.log(wa.words[1].toString(16));
        this.version = V[wa.words[1]];
        if(this.version == null) err = new Error("bad header; couldn't find a good version (got " + wa.words[1] + ")");
        else{
          if(wa.words[0] !== this.version.header[0]) err = new Error("Bad header: unrecognized magic value");
          else err = null;
        }
      }
