...
export default class AuthenticatedAuthorshipView2 {
  ...
  constructor(){
    ...
    <label for="aaPrivateKey2" style="color:white;font-size:1.2em;padding-top:5px;">Private Key:</label><br>
    ...
    <button id="aaSignToTextButton2" style="color:black;font-size:1.2em;">Sign to Text</button>
    <button id="aaSignToHtmlButton2" style="color:black;font-size:1.2em;">Sign to Html</button>
  ...
  */
  ...
  //Returns the login button.
  getSignToTextButton(){
    return document.getElementById('aaSignToTextButton2');
  }

  //Returns the login button.
  getSignToHtmlButton(){
    return document.getElementById('aaSignToHtmlButton2');
  }
