      ...
      self.kbLogin.login({
        ...
        if(err) console.log(err);
          ...
          var privateKey = self.triplesec.decrypt({
            ...
            'key': new self.triplesec.Buffer(password),
            //'key': new self.triplesec.Buffer('690f8181c44abcc1464c99b1caad016d'),
            //'key': new Buffer(res.me.private_keys.primary.bundle),
            //'data': self.triplesec.WordArray.from_utf8(res.me.private_keys.primary.bundle)
            'data': new self.triplesec.Buffer(res.me.private_keys.primary.bundle, 'hex')
            //'data': new Buffer(password)
          ...
          */
          ...
          console.log('base64', self.base64);
          var step1 = self.base64.parse(res.me.private_keys.primary.bundle);
          console.log('step1', step1);
          //console.log(typeof step1.words);
          //console.log(Array.isArray(step1.words));
          console.log('msgpack', self.msgpack);
          //var step2 = self.msgpack.decode(step1.words);
          //var step2 = self.msgpack.decode(self.i32a_to_u8a(step1.words));

          //var step2 = self.msgpack.decode(new Uint8Array(step1.words));
          console.log('mpack', self.mpack);
          var step2 = self.mpack.decode(new Uint8Array(step1.words));
