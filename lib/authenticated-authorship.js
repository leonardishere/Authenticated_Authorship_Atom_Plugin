...
var generateNewKey = false //as opposed to using old key
...
export default {
  ...
  */
  ...
  activate(){
    ...
    this.subscriptions.add(atom.config.onDidChange('authenticated-authorship.activateHyperMode', (event) => {
      if(event.newValue){
    ...
    /*
    atom.workspaceView.on('click', '.ok-button', () => {
      console.log('clicked');
    })
    */
    /*
    this.modalView.on('click', '.ok-button', () => {
      console.log('clicked');
    });
    */
    /*
  ...
  loadPriKey() {
    ...
    this.createPriKeyManager(priKey, passphrase)
  },
