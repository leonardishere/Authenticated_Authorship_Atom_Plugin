...
export default {
  ...
  */
  ...
  uint8a_to_string(arr){
    var length = Math.ceil(arr.length * 1.0 / 2);
    //var arr2 = new Int32Array(length);
    //console.log(this.typedArrays);
    //var arr2 = new this.typedArrays.WordArray(length);
    //var arr2 = new Uint16Array(length);
    var str = "";
    /*
    for(var i = 0; i < length; ++i){
      arr2[i] = 0;
  ...
  sign(username, priKeyManager) {
    ...
    this.kbpgp.box(params, (err, result_string, result_buffer) => {
      ...
      */
      ...
      //console.log("string to ascii: ", Buffer.from(result_string, "ascii"));
      /*
      console.log("string to utf8: ", Buffer.from(result_string, "utf8"));
      console.log("string to utf16le: ", Buffer.from(result_string, "utf16le"));
      console.log("string to ucs2: ", Buffer.from(result_string, "ucs2"));
      console.log("string to base64: ", Buffer.from(result_string, "base64"));
      console.log("string to binary: ", Buffer.from(result_string, "binary"));
      console.log("string to hex: ", Buffer.from(result_string, "hex"));
      */
      /*
      console.log("result uint8a: ", self.string_to_uint8a(result_string));
      console.log("buffer to ascii: ", result_buffer.toString('ascii'));
      console.log("buffer to utf8: ", result_buffer.toString('utf8'));
      console.log("buffer to utf16le: ", result_buffer.toString('utf16le'));
      console.log("buffer to ucs2: ", result_buffer.toString('ucs2'));
      console.log("buffer to base64: ", result_buffer.toString('base64'));
      console.log("buffer to binary: ", result_buffer.toString('binary'));
      console.log("buffer to hex: ", result_buffer.toString('hex'));
      */
      ...
      //+ "Signature: " + self.base642.fromByteArray(self.string_to_uint8a(result_string)) + "\n"
      //+ "Signature: " + self.base642.fromByteArray(result_buffer) + "\n"
  ...
  verify(){
    ...
    var self = this;
    var ascii = self.base642.toByteArray(signature);
    //var pgpSignature = String.fromCharCode(ascii);
    var pgpSignature = self.ascii_to_string(ascii);
    //var pgpSignature = self.uint8a_to_string(self.base642.toByteArray(signature));
    //var pgpSignature = new TextDecoder("utf-8").decode(self.base642.toByteArray(signature));

    var newHash = this.base64.stringify(this.sha256(article));
    ...
    //console.log("pgp signature: ", pgpSignature);
            ...
            if(err){
              ...
              if(originalHashedArticle !== hash){
                ...
                */
                ...
                //console.log("test 3");
                //console.log("Article was signed by " + author);
                //trimmedArticle += "\nDecrypted message:\n";
